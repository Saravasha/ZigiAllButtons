		...
		if (event == "ZONE_CHANGED_NEW_AREA" or event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "PLAYER_LOGIN") then
			...
			if racials[race] then
				...
				elseif class == "WARLOCK" then
					...
					EditMacro("WSxGen5",nil,nil,"/use [pet:Voidwalker/Voidlord,mod]Suffering;[mod]Fel Domination\n/use [nopet:Voidwalker/Voidlord,mod]Summon Voidwalker;[spec:1]Shadow Bolt;[@mouseover,spec:2,harm,nodead][spec:2]Demonbolt;Conflagrate\n/use Fire-Eater's Vial\n/targetenemy [noexists]")
					...
					EditMacro("WSxSGen+6",nil,nil,"/use [spec:3,@player]Rain of Fire;[spec:2,nopet]Summon Felguard;[pet:felguard/wrathguard]!Felstorm;[talent:4/2]Phantom Singularity;[talent:4/3,@player]Vile Taint;Command Demon\n/stopmacro [@pet,nodead]\n/run PetDismiss()")
					...
					EditMacro("WSxSGen+F",nil,nil,"/use [mod,nocombat,noexists]Gastropod Shell;[pet:Felguard/Wrathguard,nomod]Threatening Presence;[pet:Imp]Flee;[pet:Voidwalker]Suffering\n/petautocasttoggle [mod]Legion Strike;[pet:Voidwalker]Suffering;Threatening Presence")
					...
					EditMacro("WSxGG",nil,nil,"/use [mod:alt]S.F.E. Interceptor;[pet:Voidwalker/Voidlord]Consuming Shadows;[@mouseover,exists,nodead][exists,nodead]Command Demon;Tickle Totem")
