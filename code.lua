...
--[[				DEFAULT_CHAT_FRAME:AddMessage("ZigiAllButtons: New area detected: "..parent.name..".\nRecalibrating zone based macros :)",0.5,1.0,0.0)--]]			
				...
				elseif class == "ROGUE" then
					ccz = "[combat]Vanish;[stance:0,nocombat]Stealth;[spec:1]Deadly Poison;[spec:2]Instant Poison;Slightly-Chewed Insult Book"
				elseif class == "PRIEST" then
...
--[[					print(PvPTalentNames[i])
			...
			if racials[race] then
				...
				if class == "SHAMAN" then
					...
					EditMacro("WSxGen4",nil,nil,"/use [spec:1,talent:2/2]Echoing Shock;[spec:1,talent:2/3][spec:2,talent:1/3]Elemental Blast;[spec:1,talent:6/3]Frost Shock;[spec:1]Earth Shock;[spec:2]Lava Lash;[@mouseover,help,nodead][]\n/targetenemy [noexists]\n/cleartarget [dead]")
					...
					EditMacro("WSxGen5",nil,nil,"#showtooltip\n/use [mod:ctrl,@player]Earth Elemental;[spec:1]Earth Shock;[spec:2][@mouseover,harm,nodead,spec:2][harm,nodead,spec:2]Lightning Bolt;[@mouseover,help,nodead][]Healing Wave\n/targetenemy [noexists]\n/use Words of Akunda")
					...
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [spec:1,mod:shift,@player][spec:1,@cursor]Earthquake;[@mouseover,harm,nodead][harm,nodead]Chain Lightning;Bom'bay's Color-Seein' Sauce\n/startattack\n/use [noexists,nocombat]Moonfang's Paw")
					...
					EditMacro("WSxGen+B",nil,nil,"#showtooltip\n/use [spec:2,talent:4/3]Fire Nova;[spec:3]Mana Tide Totem")
					...
					EditMacro("WSxGND",nil,nil,"/use [mod:alt,spec:2]Windfury Weapon;[mod:ctrl]Astral Recall;[mod,spec:2]Spirit Walk;[mod]Spiritwalker's Grace;[@mouseover,talent:3/2,help,nodead][@mouseover,spec:3,help,nodead][talent:3/2][spec:3]Earth Shield\n/use Void Totem")
				...
				elseif class == "MAGE" then
					...
					EditMacro("WSxT90",nil,nil,"#showtooltip [spec:3,talent:6/3]Comet Storm;[spec:2,talent:6/3]Living Bomb;[spec:1,talent:7/3]Arcane Orb;Ancient Mana Basin\n/use [mod:alt,@player,talent:5/3][@cursor,talent:5/3]Ring of Frost")
					EditMacro("WSxT100",nil,nil,"#showtooltip [spec:3,talent:7/3]Glacial Spike;[spec:3,talent:7/2]Ray of Frost;[spec:2,talent:7/3]Meteor")
					EditMacro("WSxCSGen+G",nil,nil,"#showtooltip [spec:3]Cold Snap;Spellsteal\n/use [@focus,harm,nodead]Spellsteal\n/use Poison Extraction Totem")
					EditMacro("WSxT60",nil,nil,"#showtooltip [spec:3,talent:4/3]Ebonbolt;[spec:1,talent:4/3]Nether Tempest\n/use Worn Doll\n/run PetDismiss();\n/cry")
					...
					EditMacro("WSxGen2",nil,nil,"/use [spec:1,harm,nodead]Arcane Blast;[spec:3,harm,nodead]Frostbolt;[@mouseover,harm,nodead][harm,nodead]Scorch;[nocombat]Akazamzarak's Spare Hat\n/targetenemy [noharm]\n/cleartarget [dead]\n/use [nocombat,noexists]Kalec's Image Crystal")
					...
					EditMacro("WSxGen5",nil,nil,"#showtooltip\n/targetenemy [noexists]\n/use [mod:ctrl]!Alter Time;[@mouseover,harm,nodead,spec:1][spec:1]Arcane Barrage;[nospec:1,@mouseover,harm,nodead][nospec:1]Fire Blast")
					...
					EditMacro("WSxSGen+6",nil,nil,"/use [nocombat,noexists]Mystical Frosh Hat\n/use [spec:1,talent:1/3]Arcane Familiar;[spec:2,talent:7/3,@player]Meteor;[spec:2,@player]Flamestrike;[spec:3,@player]Blizzard\n/targetenemy [noharm]\n/cleartarget [noharm]")
					EditMacro("WSxGen7",nil,nil,"/use [mod,spec:2,@player]Flamestrike;[spec:3,talent:1/3]Ice Nova;[spec:2,talent:2/3]Blast Wave;[spec:2]Dragon's Breath;[spec:1]Arcane Explosion;Cone of Cold")
					...
					EditMacro("WSxRTS",nil,nil,"/use [noexists,mod:alt]MOLL-E;[spec:3,mod]Cone of Cold;[spec:2,mod]Dragon's Breath;[@mouseover,harm,nodead,spec:1,mod][spec:1,mod]Slow;[@mouseover,help,nodead]Slow Fall;[@mouseover,harm,nodead][]Frostbolt")
					EditMacro("WSxClassT",nil,nil,"#show [spec:3,notalent:1/2]Summon Water Elemental;[spec:1]Displacement;Frost Nova\n/use [@mouseover,harm,nodead][harm,nodead]Fire Blast;[help,nocombat]Swapblaster;[nocombat]Trans-Dimensional Bird Whistle\n/petattack [@mouseover,harm,nodead][]")
					...
					if playerspec == 1 then
						...
						EditMacro("WSxSGen+4",nil,nil,"#showtooltip\n/targetenemy [noexists]\n/use Evocation")
						EditMacro("WSxSGen+5",nil,nil,"#showtooltip\n/targetenemy [noexists]\n/use [@mouseover,harm,nodead][]Touch of the Magi\n/cleartarget [dead]\n/clearfocus [dead]")
					elseif playerspec == 2 then
				...
				elseif class == "WARLOCK" then
					...
					EditMacro("WSxT90",nil,nil,"#show [spec:2,talent:6/3]Grimoire: Felguard;[spec:1,talent:6/2]Haunt;[spec:1,talent:6/3]Grimoire of Sacrifice\n/use [help,nocombat]Swapblaster;[pet:Voidwalker/Voidlord]Consuming Shadows\n/use [@mouseover,harm,nodead][]Curse of Weakness")
					...
					EditMacro("WRessMix",nil,nil,"/cancelaura Slow Fall\n/cancelaura Levitate\n/cancelaura Goblin Glider\n/use [mod:alt]Jeeves;[mod:ctrl]15;[mod:shift]6;[nocombat]Ultimate Gnomish Army Knife;"..pwned.."\n/use [mod:ctrl]Brazier of Awakening")
					EditMacro("WSxGen1",nil,nil,"/use [@mouseover,harm,nodead,spec:3][spec:3]Havoc;[spec:2,talent:4/2]Soul Strike;[spec:2,talent:4/3]Summon Vilefiend;[spec:1,@mouseover,harm,nodead][spec:1]Corruption\n/use Copy of Daglop's Contract\n/targetenemy [noexists]")
					...
					EditMacro("WSxGen7",nil,nil,"/use [mod:shift,nopet]Summon Imp;[mod:shift,pet:Imp]Flee;[nocombat,noexists,nomod]Legion Pocket Portal;[spec:2]Implosion;[spec:3,talent:4/3,@cursor]Cataclysm;[spec:1]Malefic Rapture\n/targetenemy [noexists]")
					...
					EditMacro("WSxRTS",nil,nil,"/use [mod:alt,nocombat]Moll-E;[mod:ctrl,nopet]Summon Succubus;[@mouseover,harm,nodead,talent:5/2][talent:5/2,mod]Mortal Coil;[talent:5/3,mod]Howl of Terror;[@mouseover,harm,nodead][]Curse of Exhaustion\n/targetenemy [noharm]")
					...
					EditMacro("WSxCGen+F",nil,nil,"#showtooltip\n/use [nocombat,noexists,pet:Succubus/Shivarra]Lesser Invisibility;[group:party/raid]Ritual of Doom;Bewitching Tea Set\n/use "..fftpar.."\n/cancelaura Wyrmtongue Disguise\n/cancelaura Burning Rush\n/cancelaura Crystalline Eye of Undravius")
					...
					EditMacro("WSxSGen+H",nil,nil,"#showtooltip Demonic Circle\n/use Demonic Circle: Teleport;Legion Communication Orb\n/stopmacro [combat]\n/run if not (IsControlKeyDown()) then if IsMounted() then DoEmote\"mountspecial\"; else DoEmote\"kneel\" end end")
					EditMacro("WSxDef",nil,nil,"#showtooltip\n/use [mod:alt,@cursor]Demonic Gateway;Unending Resolve\n/stopspelltarget")
					EditMacro("WSxGND",nil,nil,"/use [mod:shift]Demonic Circle: Teleport;[mod:alt,group]Create Soulwell;[mod:alt]Create Healthstone;[mod,harm,nodead]Subjugate Demon;[mod,group]Ritual of Summoning;[mod]Unstable Portal Emitter;[talent:3/2]!Burning Rush;[talent:3/3]Dark Pact;Void Totem")
				...
				elseif class == "MONK" then
					...
					EditMacro("WSxT60",nil,nil,"#showtooltip [spec:1,talent:4/2]Summon Black Ox Statue;[spec:2,talent:4/2]Song of Chi-Ji;[talent:4/3]Ring of Peace;\n/click TotemFrameTotem1 RightButton\n/run PetDismiss()\n/use [noexists,nocombat]Turnip Punching Bag")
					...
					EditMacro("WSxSGen+5",nil,nil,"/use [@party2,help,nodead,mod:alt,spec:2]Renewing Mist;[spec:3,talent:3/2]Fist of the White Tiger;[spec:3,talent:3/3]Energizing Elixir;[spec:1]Ironskin Brew;[spec:2]Thunder Focus Tea\n/use Displacer Meditation Stone\n/targetenemy [noexists]")
					...
					EditMacro("WSxGen6",nil,nil,"#showtooltip\n/use [spec:3,mod:ctrl]Invoke Xuen, the White Tiger;[spec:2,mod:ctrl]Invoke Yu'lon, the Jade Serpent;[mod]Invoke Niuzao, the Black Ox;[spec:1]Breath of Fire;!Spinning Crane Kick\n/use Words of Akunda")
					...
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [nocombat,noexists]Brewfest Pony Keg;[spec:3,talent:7/2]Whirling Dragon Punch;[spec:3]Storm, Earth, and Fire;!Spinning Crane Kick")
					...
					EditMacro("WSxStuns",nil,nil,"/use [mod:alt]Leg Sweep;[@mouseover,harm,nodead,spec:1][spec:1]Clash;[@mouseover,help,nodead,spec:2][spec:2]Soothing Mist;[spec:3]Flying Serpent Kick")
					...
					EditMacro("WSxCGen+F",nil,nil,"#showtooltip [spec:1,talent:4/2]Summon Black Ox Statue;[spec:2,talent:4/2]Song of Chi-Ji;[talent:4/3]Ring of Peace;[spec:3]Touch of Karma;[spec:2]Fortifying Brew\n/use [spec:3]Touch of Karma;[spec:2]Revival;[spec:1]Zen Meditation")
					...
					if playerspec == 1 then
						...
						EditMacro("WSxSGen+3",nil,nil,"#showtooltip\n/use [mod,@player,talent:6/3][@cursor,talent:6/3]Exploding Keg;[talent:6/2]Rushing Jade Wind;Tiger Palm")
					...
					elseif playerspec == 2 then
						EditMacro("WSxCGen+4",nil,nil,"#showtooltip\n/use [talent:6/2]Refreshing Jade Wind;[talent:6/1,@cursor]Summon Jade Serpent Statue;Invoke Yu'lon, the Jade Serpent\n/startattack")
						EditMacro("WSxSGen+3",nil,nil,"/use [@party4,help,nodead,nochanneling:Soothing Mist,mod][nochanneling:Soothing Mist,@mouseover,help,nodead,nomod][nochanneling:Soothing Mist,nomod]Soothing Mist;[@mouseover,help,nodead,nomod][nomod]Enveloping Mist;[@party4,nodead,mod]Vivify")
						...
						EditMacro("WSxSGen+3",nil,nil,"/use [talent:6/2]Rushing Jade Wind;Tiger Palm")
						EditMacro("WSxSGen+1",nil,nil,"#showtooltip\n/use [mod:ctrl,@party2,help,nodead][@focus,help,nodead][@party1,help,nodead][@targettarget,help,nodead]Vivify;Honorary Brewmaster Keg\n/targetexact Reaves\n/tar Captain Krooz")
						EditMacro("WSxSGen+2",nil,nil,"/use [@party3,help,nodead,mod:alt][@mouseover,help,nodead][]Vivify\n/use [nochanneling]Gnomish X-Ray Specs")
					end
				...
				elseif class == "PALADIN" then
					...
					EditMacro("WSxT100",nil,nil,"#showtooltip [spec:3,talent:7/3]Inquisition;[spec:1,talent:7/2]Beacon of Faith;[spec:1,talent:7/3]Beacon of Virtue;Avenging Wrath")
					...
					EditMacro("WSxSGen+3",nil,nil,"/use [@party3,help,nodead,mod:alt]Holy Light;[spec:1,talent:4/3]Rule of Law;[spec:3,talent:1/3]Execution Sentence;Consecration\n/targetenemy [noexists]")
					...
					EditMacro("WSxCGen+4",nil,nil,"/use [spec:1,@mouseover,help,nodead,talent:7/2][spec:1,talent:7/2]Beacon of Faith;[spec:1,@mouseover,help,nodead][spec:1]Beacon of Light;[spec:3,talent:7/3]Final Reckoning\n/targetenemy [noexists]\n/use Soul Evacuation Crystal")
					...
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [mod:shift,spec:1,talent:5/2]Holy Avenger;[mod:shift,spec:1,talent:5/3]Seraphim;Consecration\n/targetenemy [noexists]")
					...
					elseif playerspec == 2 then
						...
						EditMacro("WSxSGen+4",nil,nil,"/use [spec:2,talent:2/3]Moment of Glory;Judgment\n/targetenemy [noexists]")
					else
				...
				elseif class == "HUNTER" then					
					...
					EditMacro("WRessMix",nil,nil,"/cancelaura Slow Fall\n/cancelaura Levitate\n/cancelaura Goblin Glider\n/use [mod:alt]Jeeves;[mod:ctrl]15;[mod:shift]6;[nocombat]Ultimate Gnomish Army Knife;"..pwned.."\n/use [mod:ctrl]Brazier of Awakening")
					EditMacro("WSxT60",nil,nil,"#showtooltip Dismiss Pet\n/use Dismiss Pet\n/click TotemFrameTotem1 RightButton\n/use Crashin' Thrashin' Robot")
					...
					EditMacro("WSxGen1",nil,nil,"/targetlasttarget [noharm,nodead,nocombat]\n/use [@mouseover,help,nodead]Misdirection;[@mouseover,harm,nodead][harm,nodead]Hunter's Mark;[help,nodead]Corbyn's Beacon;[harm,dead]Fetch;Fetch")
					...
					EditMacro("WSxGen2",nil,nil,"#showtooltip\n/use [nocombat,noexists]Mrgrglhjorn;[spec:1]Barbed Shot;Steady Shot\n/use Gnomish X-Ray Specs\n/targetenemy [noexists]\n/use Words of Akunda")
					EditMacro("WSxSGen+2",nil,nil,"#showtooltip\n/use [spec:1,pet,nopet:Spirit Beast][spec:3,pet]Dismiss Pet;[nopet]Call Pet 2;[@mouseover,help,nodead,pet:Spirit Beast][pet:Spirit Beast,help,nodead][pet:Spirit Beast,@player]Spirit Mend;[spec:3]Aracane Shot;Dismiss Pet\n/use Totem of Spirits")
					...
					EditMacro("WSxGen3",nil,nil,MSK.."\n/use [@mouseover,harm,nodead][harm,nodead]Kill Shot;[nocombat,noexists]Imaginary Gun\n/targetenemy [noexists]\n/startattack\n/cleartarget [dead]\n/stopspelltarget")
					EditMacro("WSxCSGen+3",nil,nil,"/use [@focus,help,nodead][@party2,help,nodead]Misdirection;[nocombat,noharm]Cranky Crab")
					EditMacro("WSxGen4",nil,nil,"#showtooltip\n/use [noexists,nocombat]Puntable Marmot;[help,nodead]Dalaran Disc;[spec:2]Aimed Shot;Kill Command\n/targetenemy [noexists]\n/startattack\n/cancelaura Aspect of the Turtle\n/cleartarget [dead]\n/petattack")
					-- t90
					EditMacro("WSxSGen+4",nil,nil,"/use [spec:1,talent:6/2]Barrage;[spec:1,talent:6/3]Stampede;[spec:2,talent:6/3]Double Tap;[spec:3,talent:6/3]Flanking Strike;Misdirection")
					EditMacro("WSxCGen+4",nil,nil,"/use [nopet]Call Pet 3;[pet:Crab,help,pet]Crab Shank;[nocombat,noexists]Gastropod Shell;[spec:1,talent:7/3]Bloodshed;[spec:2,talent:7/3]Volley;[talent:7/3]Chakrams\n/target pet [pet:Crab]\n/targetlasttarget [pet:Crab]")
					...
					-- t60
					EditMacro("WSxSGen+5",nil,nil,"#showtooltip\n/use [nocombat,noexists,mod]Pandaren Scarecrow;[spec:2,talent:4/3]Chimaera Shot;[talent:4/2,@cursor]Steel Trap;[talent:4/3]A Murder of Crows")
					...
					EditMacro("WSxSGen+6",nil,nil,"#showtooltip\n/use [nocombat,noexists]Laser Pointer;[spec:3]Wildfire Bomb;[spec:2]Rapid Fire;[spec:1]Aspect of the Wild")
					EditMacro("WSxGen7",nil,nil,"/use [mod]Command Pet;[nocombat,noexists]Fireworks;[spec:3]Aspect of the Eagle;[spec:1,talent:2/3]Chimaera Shot;[talent:2/3]Explosive Shot;[talent:2/2]Barrage\n/use Will of Northrend\n/use Bom'bay's Color-Seein' Sauce")
					...
					EditMacro("WSxStuns",nil,nil,"/targetenemy [noexists]\n/stopspelltarget\n/use [mod:alt,@cursor]Flare;[@mouseover,harm,nodead,spec:3][spec:3]Harpoon;[nocombat,noexists]Party Totem;[spec:2]Bursting Shot;[@cursor,talent:5/3]Binding Shot;Intimidation\n/cleartarget [dead]")
					EditMacro("WSxRTS",nil,nil,"/use [mod:alt,noexists]MOLL-E;[mod:shift,@cursor]Tar Trap;[mod,@player][@mouseover,help,nodead,nomod][help,nodead,nomod]Master's Call;[spec:3,nomod]Wing Clip;[mod:alt,@focus,harm,nodead][@mouseover,harm,nodead][]Concussive Shot\n/targetenemy [noharm]")
					...
					EditMacro("WSxMove",nil,nil,"#showtooltip\n/use Disengage\n/stopcasting\n/use Crashin' Thrashin' Robot\n/use [nomod]Panflute of Pandaria\n/cancelaura Rhan'ka's Escape Plan\n/use Ruthers' Harness")
					EditMacro("WSxCGen+V",nil,nil,"/use [mod:alt,nocombat]"..passengerMount..";[@mouseover,harm,nodead][]Scare Beast\n/use [swimming]Barnacle-Encrusted Gem\n/use [nomod]Whispers of Rai'Vosh")
					EditMacro("WSxSRBGCC+1",nil,nil,"")
					if playerspec == 1 then
						EditMacro("WSxSGen+3",nil,nil,"#showtooltip\n/use [nocombat,noexists]"..factionFireworks..";[spec:1,talent:1/3]Dire Beast;Arcane Shot\n/use Everlasting Darkmoon Firework\n/use Power Converter\n/use Pandaren Firework Launcher\n/startattack")
				...
				elseif class == "ROGUE" then
					...
					EditMacro("WSxT15",nil,nil,"#showtooltip [spec:2,talent:1/1]Ghostly Strike;[spec:1,talent:1/3]Blindside;[spec:3,talent:1/3]Backstab;Wound Poison\n/use "..invisPot)
					...
					EditMacro("WSxT90",nil,nil,"#showtooltip [spec:2,talent:6/3]Dreadblades;[spec:3,talent:6/3]Enveloping Shadows;[spec:1,talent:6/2]Toxic Blade;[spec:1,talent:6/3]Exsanguinate\n/use [mod:alt,@player][]Distract")
					...
					EditMacro("WSxGen2",nil,nil,"/targetenemy [noexists]\n/use [stance:0,nocombat]Stealth;[stealth,nostance:3,nodead]Pick Pocket;[spec:2]Sinister Strike;[spec:3]Shadowstrike;[talent:6/3]Exsanguinate;Shiv\n/cleartarget [exists,dead]\n/stopspelltarget")
					...
					EditMacro("WSxGen3",nil,nil,"/use [stance:0,nocombat]Stealth;[stance:0,combat,spec:3]Shadow Dance;[nostance:0,spec:3]Shadowstrike;[spec:2]Between The Eyes;Sinister Strike")
					...
					EditMacro("WSxGen4",nil,nil,"#showtooltip\n/use [nocombat,noexists,spec:2]Dead Ringer\n/use [stance:0,nocombat]Stealth;[stance:1/2/3]Ambush;[spec:2,talent:1/3]Ghostly Strike;[spec:3]Backstab;[spec:1]Sinister Strike;Pistol Shot\n/targetenemy [noexists]\n/cleartarget [dead]")
					...
					EditMacro("WSxCGen+4",nil,nil,"#showtooltip\n/use [spec:2,talent:6/3]Dreadblades;[spec:1]Vendetta;[spec:2]Adrenaline Rush;Shadow Blades\n/targetenemy [noexists,nocombat]\n/use [nocombat,noexists]Gastropod Shell")
					...
					EditMacro("WSxSGen+6",nil,nil,"/use [stance:0,nocombat]Stealth;[spec:2,talent:7/2]Blade Rush;[spec:2,talent:7/3]Killing Spree;[spec:1,talent:7/3]Crimson Tempest;[spec:3,talent:7/2]Secret Technique;[spec:3,talent:7/3]Shuriken Tornado;[spec:3]Shuriken Storm")
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [nocombat,help]Corbyn's Beacon;[spec:3]Shadow Vault;[spec:2]Roll the Bones;[@mouseover,harm,nodead][]Rupture\n/use [stance:0]Stealth;Autographed Hearthstone Card")
					...
					EditMacro("WSxDef",nil,nil,"#showtooltip\n/use [mod:alt]Wound Poison;[mod:ctrl,spec:1]Deadly Poison;[mod:ctrl]Instant Poison;[stance:0,nocombat]Stealth;[spec:2,combat]Riposte;[nospec:2,combat]Evasion;[stance:1]Shroud of Concealment")
					...
					EditMacro("WSxCGen+V",nil,nil,"/use [mod:alt,nocombat]"..passengerMount..";[swimming]Barnacle-Encrusted Gem;Survivor's Bag of Coins\n/use [nomod] Whispers of Rai'Vosh")
					if playerspec == 1 then
				...
				elseif class == "PRIEST" then
					...
					EditMacro("WSxT30",nil,nil,"#showtooltip Power Word: Shield\n/use Desperate Prayer"..oOtas)
					...
					EditMacro("WSxT100",nil,nil,"#showtooltip [spec:3,talent:7/3]Surrender to Madness;[spec:2,talent:7/2]Apotheosis;[spec:2,talent:7/3]Holy Word: Salvation;[spec:1,talent:7/2]Power Word: Barrier;[spec:1,talent:7/3]Evangelism;Smite")
					...
					EditMacro("WSxGen1",nil,nil,"/use [help,nodead]The Heartbreaker;[spec:1,talent:1/3]Schism;[spec:2]Holy Fire;[spec:3,talent:6/3]Void Torrent;[@mouseover,harm,nodead,spec:3,talent:6/1][spec:3,talent:6/1]Damnation;Shadow Word: Pain\n/use [nocombat,noexists]Dead Ringer\n/startattack")	    
					...
					EditMacro("WSxGen3",nil,nil,"/targetenemy [noexists]\n/cleartarget [dead]\n/use [help,nocombat]Scarlet Confessional Book;Shadow Word: Death\n/petattack\n/use Ivory Feather")
					...
					EditMacro("WSxSGen+5",nil,nil,"/use [nocombat,nochanneling]Soul Evacuation Crystal\n/use [@mouseover,harm,nodead,spec:3][spec:3]Devouring Plague;[spec:3]Mind Sear;[talent:6/2]Divine Star;[talent:6/3]Halo\n/targetenemy [noexists]")
					...
					EditMacro("WSxSGen+6",nil,nil,"/use [@player,spec:3,talent:5/3][@cursor,spec:3,talent:5/3]Shadow Crash;[@mouseover,help,nodead,spec:2][spec:2]Prayer of Healing;[@mouseover,help,nodead,spec:1][spec:1]Power Word: Radiance;Shadowfiend\n/use Cursed Feather of Ikzan")
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [help,nodead,nocombat,nomod]Corbyn's Beacon;[spec:1,mod]Rapture;[spec:2,mod:shift,@player][spec:2,@cursor]Holy Word: Sanctify;[spec:1,@player]Penance;[spec:3,talent:3/3]Searing Nightmare;Holy Nova")
					...
					EditMacro("WSxGen+B",nil,nil,"/use [@mouseover,help,nodead][]Power Infusion")
					if playerspec == 1 then
						EditMacro("WSxSGen+4",nil,nil,"#showtooltip\n/targetenemy [noexists]\n/cleartarget [dead]\n/use [@mouseover,help,nodead,talent:5/3][talent:5/3]Shadow Covenant;Smite\n/use [nocombat,noexists]Leather Love Seat\n/stopspelltarget")
						EditMacro("WSxCGen+4",nil,nil,"#showtooltip\n/use [talent:7/3]Evangelism;Rapture\n/targetenemy [noexists]\n/cleartarget [dead]")
						EditMacro("WSxGen5",nil,nil,"/use [mod:ctrl,spec:1,@cursor]Power Word: Barrier;[@mouseover,harm,nodead,talent:3/3][talent:3/3]Power Word: Solace;Holy Nova\n/use [help,nodead]Apexis Focusing Shard\n/targetenemy [noexists]")
						...
						EditMacro("WSxClassT",nil,nil,"/use [@mouseover,help,nodead][help,nodead]Leap of Faith;Trans-Dimensional Bird Whistle\n/use [help,nocombat]Swapblaster\n/cleartarget [dead]")
						EditMacro("WSxGND",nil,nil,"/use [mod:alt]Mind Soothe;[mod:shift]Fade;[mod,harm,nodead]Mind Control;[@mouseover,help,nodead][]Power Word: Shield\n/use [nocombat]Bubble Wand\n/use Void Totem\n/cancelaura Bubble Wand")
					elseif playerspec == 2 then
						...
						EditMacro("WSxClassT",nil,nil,"/use [@mouseover,harm,nodead][harm,nodead]Holy Word: Chastise;[@mouseover,help,nodead][help,nodead]Leap of Faith;Trans-Dimensional Bird Whistle\n/use [help,nocombat]Swapblaster\n/cleartarget [dead]")
						EditMacro("WSxGND",nil,nil,"/use [mod:alt]Mind Soothe;[mod:shift]Fade;[mod,harm,nodead]Mind Control;[spec:2,@mouseover,help,nodead][spec:2]Prayer of Mending\n/use [nocombat]Bubble Wand\n/use Void Totem\n/cancelaura Bubble Wand")
					else						
						...
						EditMacro("WSxClassT",nil,nil,"/use [mod:alt,@focus,harm,nodead,talent:4/3][@mouseover,harm,nodead,talent:4/3][talent:4/3,harm,nodead]Psychic Horror;[@mouseover,help,nodead][help,nodead]Leap of Faith;Trans-Dimensional Bird Whistle\n/use [help,nocombat]Swapblaster\n/cleartarget [dead]")
				...
				elseif class == "DEATHKNIGHT" then
					...
					EditMacro("WSxT15",nil,nil,"#showtooltip [spec:1,talent:1/2]Blooddrinker;[spec:1,talent:1/3]Tombstone;[spec:1,talent:1/3]Rune Strike\n/use "..invisPot)
					...
					EditMacro("WSxT90",nil,nil,"#showtooltip [spec:2,talent:6/2]Hypothermic Presence;[spec:2,talent:6/3]Glacial Advance;[spec:3,talent:6/2]Epidemic;[spec:3]Death and Decay;[spec:2,talent:6/1];[spec:1,talent:6/2]Death Pact\n/use Dark Command\n/use Blight Boar Microphone")
					EditMacro("WSxT100",nil,nil,"#showtooltip [spec:2,talent:7/3]Breath of Sindragosa;[spec:3,talent:7/3]Unholy Assault;[spec:1,talent:7/3]Bonestorm;")
					...
					EditMacro("WSxT60",nil,nil,"#showtooltip [spec:1,talent:4/3]Mark of Blood;[spec:2,talent:4/3]Frostscythe;[spec:3,talent:4/3]Soul Reaper\n/use Sylvanas' Music Box\n/run PetDismiss();\n/cry")
					EditMacro("WRessMix",nil,nil,"/cancelaura Slow Fall\n/cancelaura Levitate\n/cancelaura Goblin Glider\n/use [mod:alt]Jeeves;[mod:ctrl]15;[mod:shift]6;[nocombat]Ultimate Gnomish Army Knife;"..pwned.."\n/use [mod:ctrl]Brazier of Awakening")
					...
					EditMacro("WSxCAGen+N",nil,nil,"")
					EditMacro("WSxGen1",nil,nil,"#showtooltip\n/cast [@mouseover,help,dead][help,dead]Raise Ally;[spec:2,talent:6/2]Hypothermic Presence;[spec:2,talent:6/3]Glacial Advance;[spec:3]Apocalypse;[spec:1,talent:1/2]Blooddrinker;[spec:1,talent:1/3]Tombstone;Death Strike\n/targetenemy [noexists]")
					...
					EditMacro("WSxSGen+3",nil,nil,"/use [spec:2,talent:2/3]Horn of Winter;[spec:3,@mouseover,harm,nodead][spec:3]Outbreak;[spec:1,@mouseover,harm,nodead][spec:1]Death's Caress;[spec:2]Howling Blast\n/startattack\n/stopspelltarget\n/use [nospec:2]Aqir Egg Cluster;Vrykul Drinking Horn")
					...
					EditMacro("WSxGen5",nil,nil,"#showtooltip\n/use [mod:ctrl,spec:3,@player]Army of the Dead;[spec:1,talent:2/3]Consumption;[spec:1]Death Strike;[spec:2]Frost Strike;[@mouseover,exists,nodead][]Death Coil\n/startattack\n/cleartarget [dead]")
					...
					EditMacro("WSxGen6",nil,nil,"#showtooltip\n/use [spec:2,mod:ctrl]Pillar of Frost;[spec:3,mod:ctrl]Summon Gargoyle;[spec:1]Heart Strike;[spec:3,talent:6/2]Epidemic;[spec:3,@cursor]Death and Decay;[spec:2]Remorseless Winter\n/use [mod:ctrl]Angry Beehive")
					EditMacro("WSxSGen+6",nil,nil,"#showtooltip\n/use [spec:2]Frostwyrms Fury;[@player]Death and Decay\n/use [noexists,nocombat,spec:1] Vial of Red Goo\n/stopspelltarget\n/cancelaura Secret of the Ooze")
					...
					EditMacro("WSxClassT",nil,nil,"#showtooltip Dark Command\n/use [help,nocombat]Swapblaster;[nocombat]Trans-Dimensional Bird Whistle;[spec:1]Blood Tap;[spec:2]Sacrificial Pact\n/petattack [@mouseover,exists,nodead][]\n/startattack")
					...
					EditMacro("WSxGG",nil,nil,"/use [mod:alt,@focus,harm,nodead]Death Grip;[mod:alt]S.F.E. Interceptor;[spec:3,nopet]Raise Dead;[@mouseover,harm,nodead,spec:3][spec:3,pet,harm,nodead]Leap;[spec:1]Rune Tap\n/use [nocombat]Lilian's Warning Sign")
					...
					EditMacro("WSxCC",nil,nil,"#showtooltip\n/use [mod:shift,nopet]Raise Dead\n/use [spec:1,talent:6/2,mod:shift]Death Pact;[mod:shift,nospec:1]Sacrificial Pact;[spec:2,talent:3/3]Blinding Sleet;[spec:3,talent:3/3][spec:2,talent:3/2][spec:1]Asphyxiate\n/cancelaura X-Ray Specs")
					EditMacro("WSxMove",nil,nil,"#showtooltip\n/use !Death's Advance\n/use Syxsehnz Rod\n/use [nomod]Panflute of Pandaria\n/cancelaura Rhan'ka's Escape Plan")
				...
				elseif class == "WARRIOR" then	
					...
					EditMacro("WSxT45",nil,nil,"#showtooltip [spec:2,talent:3/3]Onslaught;[spec:1,talent:3/3]Rend;[spec:3]Demoralizing Shout;Execute\n/use [spec:3]Demoralizing Shout;[@mouseover,harm,nodead][]Intimidating Shout;\n/startattack\n/targetenemy")
					...
					EditMacro("WSxCSGen+4",nil,nil,"")
					EditMacro("WSxGen5",nil,nil,"/use [mod]Rallying Cry;[spec:1]Slam;[spec:2,talent:3/3]Onslaught;[spec:2]Execute;[spec:3]Revenge\n/startattack\n/cleartarget [dead]\n/stopmacro [nomod]\n/use [mod]Gamon's Braid\n/roar")
					EditMacro("WSxSGen+5",nil,nil,"#showtooltip\n/use [spec:2,talent:6/2]Dragon Roar;[nospec:2,talent:7/3]Ravager;[spec:1][spec:2,talent:6/3]Bladestorm;Whirlwind\n/startattack")
					EditMacro("WSxCSGen+5",nil,nil,"/clearfocus")
					EditMacro("WSxGen6",nil,nil,"#showtooltip [spec:3]Thunder clap;Whirlwind;\n/use [spec:2,talent:7/1,mod:ctrl][spec:1,mod:ctrl]Bladestorm;[spec:3,talent:6/3,mod:ctrl]Ravager;[nospec:3]Whirlwind;[spec:3]Thunder Clap\n/startattack\n/use Words of Akunda")
					...
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [mod:shift]Shield Block;"..warPvPExc.."[spec:3]Whirlwind;[equipped:Shields]Shield Slam;[spec:2,talent:6/2]Dragon Roar;[spec:2,talent:6/3]Bladestorm\n/startattack\n/use Mote of Light\n/use World Shrinker")
					...
					EditMacro("WSxRTS",nil,nil,"/use [mod:alt,@focus,harm,nodead][nomod]Hamstring;[mod:alt]MOLL-E;[nospec:3,mod:shift]Piercing Howl;[@mouseover,help,nodead,nomod][help,nodead,nomod]Intervene\n/startattack")
					EditMacro("WSxClassT",nil,nil,"#showtooltip Taunt\n/use [@mouseover,harm,nodead][harm,nodead]Heroic Throw;[help,nocombat]Swapblaster\n/use [nocombat]Trans-Dimensional Bird Whistle\n/startattack\n/use Blight Boar Microphone")
				...
				elseif class == "DRUID" then
					...
					EditMacro("WSxT45",nil,nil,"#showtooltip\n/use [talent:4/2]Mass Entanglement;[talent:4/1]Mighty Bash;Heart of the Wild\n/use !Prowl")
					...
					EditMacro("WSxT60",nil,nil,"#showtooltip [talent:4/3]Heart of the Wild;[talent:4/2]Mass Entanglement;[talent:4/1]Mighty Bash;\n/run PetDismiss();\n/cry")
					...
					EditMacro("WSxClassT",nil,nil,"#showtooltip Growl\n/use [@mouseover,harm,nodead][harm,nodead]Cyclone;[help,nocombat]Swapblaster;[nocombat]Trans-Dimensional Bird Whistle\n/targetenemy [noexists]")
					...
					EditMacro("WSxGen7",nil,nil,"#showtooltip\n/use [mod,spec:4,@player]Efflorescence;[spec:4,talent:7/3]Flourish;[spec:4,talent:3/2,noform:2]!Cat Form;[spec:2,talent:6/3]Primal Wrath;[form:2,spec:4,talent:3/2]Swipe;[nospec:2]Barkskin\n/use [nocombat]Spirit of Bashiok")
					EditMacro("WSxGenF",nil,nil,"#showtooltip\n/focus [@mouseover,exists] mouseover\n/stopmacro [@mouseover,exists]\n/use [mod:alt]Farwater Conch;[spec:1,@focus,harm,nodead]Solar Beam;[@focus,harm,nodead]Cyclone;[@focus,harm,nodead]Skull Bash;Charm Woodland Creature\n/use Survey")
					...
					EditMacro("WSxGG",nil,nil,"#show\n/use [noform,nocombat,noexists,mod:alt]Darkmoon Gazer;[mod:alt]Stampeding Roar;[@mouseover,harm,nodead]Soothe;[spec:4,@mouseover,help,nodead][spec:4]Nature's Cure;[@mouseover,help,nodead][]Remove Corruption;\n/use Poison Extraction Totem")
					...
					if playerspec == 1 then
						...
						EditMacro("WSxGen5",nil,nil,"#showtooltip\n/use [mod:ctrl]Treant Form;[nocombat,help,nodead]Corbyn's Beacon;[form:2]Ferocious Bite;[form:1]Ironfur;Solar Wrath\n/targetenemy [noexists]\n/cleartarget [dead]")
						EditMacro("WSxGen6",nil,nil,"/use [mod]Celestial Alignment;[form:2]Swipe;[form:1,talent:3/2]Thrash;[@cursor]Starfall")
						EditMacro("WSxGND",nil,nil,"/use [mod:alt]Mount Form;[noform:2,mod:shift]!Cat Form;[mod:shift]Dash;[mod,harm,nodead]Hibernate;[mod]Dreamwalk;[form:1]Ironfur;[@mouseover,help,talent:3/3][talent:3/3]Swiftmend\n/stopmacro [stealth]\n/use Path of Elothir\n/use Prismatic Bauble")
						...
						EditMacro("WSxRTS",nil,nil,"/cancelform [talent:2/3,form,@mouseover,help,nodead]\n/use [mod:alt]MOLL-E;[mod:ctrl]Stampeding Roar;[talent:3/3,@cursor,mod]Ursol's Vortex;[talent:3/2,mod]Incapacitating Roar;[talent:2/3,noform,@mouseover,help,nodead]Wild Charge;Typhoon") 
						EditMacro("WSxSGen+5",nil,nil,"/use [@party2,help,nodead,mod]Rejuvenation;[talent:1/3,@cursor]Force of Nature;[talent:1/2]Warrior of Elune;[@player]Starfall")
					elseif playerspec == 2 then
						...
						EditMacro("WSxGen5",nil,nil,"#showtooltip\n/use [mod:ctrl]Treant Form;[nocombat,help,nodead]Corbyn's Beacon;[talent:3/1,form:4]Solar Wrath;[form:1]Ironfur;[noform]!Cat Form;[form:1]Thrash;[form:2]Ferocious Bite\n/targetenemy [noexists]\n/cleartarget [dead]")
						...
						EditMacro("WSxRTS",nil,nil,"/cancelform [talent:2/3,form,@mouseover,help,nodead]\n/use [mod:alt]MOLL-E;[mod:ctrl]Stampeding Roar;[talent:3/3,@cursor,mod]Ursol's Vortex;[talent:3/2,mod]Incapacitating Roar;[mod]Typhoon;[talent:2/3,noform,@mouseover,help,nodead]Wild Charge;Maim")
						EditMacro("WSxSGen+5",nil,nil,"/use [@party2,help,nodead,mod]Rejuvenation;[talent:7/3]Feral Frenzy;Stampeding Roar")
					elseif playerspec == 3 then
						EditMacro("WSkillbomb",nil,nil,"#showtooltip\n/use Berserk"..dpsRacials[race].."\n/use Will of Northrend\n/use 13\n/use Adopted Puppy Crate\n/use Big Red Raygun\n/use Echoes of Rezan")
						...
						EditMacro("WSxGen5",nil,nil,"#showtooltip\n/use [mod:ctrl]Treant Form;[nocombat,help,nodead]Corbyn's Beacon;[noform]Bear Form(Shapeshift);[form:1]Maul;[form:2]Ferocious Bite;[talent:3/1,form]Solar Wrath;\n/targetenemy [noexists]\n/cleartarget [dead]")
						EditMacro("WSxGen6",nil,nil,"/use [mod,talent:5/3]Berserk;[mod]Hunter's Call;[noform:1/2]Bear form(Shapeshift);[form:1/2]Swipe;")
						EditMacro("WSxGND",nil,nil,"/use [mod:alt]Mount Form;[noform:2,mod:shift]!Cat Form;[mod:shift]Dash;[mod,harm,nodead]Hibernate;[mod]Dreamwalk;[form:1]Ironfur;[@mouseover,help,talent:3/3][talent:3/3]Swiftmend\n/stopmacro [stealth]\n/use Path of Elothir\n/use Prismatic Bauble")
						...
						EditMacro("WSxRTS",nil,nil,"/cancelform [talent:2/3,form,@mouseover,help,nodead]\n/use [mod:alt]MOLL-E;[mod:ctrl]Stampeding Roar;[talent:3/3,@cursor,mod]Ursol's Vortex;[talent:3/1,mod]Typhoon;[talent:2/3,noform,@mouseover,help,nodead]Wild Charge;Incapacitating Roar")
						EditMacro("WSxSGen+5",nil,nil,"/use [@party2,help,nodead,mod]Rejuvenation;Ursine Adept")
					else
						...
						EditMacro("WSxGen5",nil,nil,"#showtooltip\n/use [mod,talent:5/3]!Incarnation: Tree of Life;[mod]Treant Form;[nocombat,help,nodead]Corbyn's Beacon;[form:2]Ferocious Bite;[form:1]Ironfur;Solar Wrath\n/targetenemy [noexists]\n/cleartarget [dead]")
						...
						EditMacro("WSxGND",nil,nil,"/use [mod:alt]Mount Form;[noform:2,mod:shift]!Cat Form;[mod:shift]Dash;[mod,harm,nodead]Hibernate;[mod]Dreamwalk;[form:1]Ironfur;[@mouseover,help,nodead][]Swiftmend\n/stopmacro [stealth]\n/use Path of Elothir\n/use Prismatic Bauble")	        
						...
						EditMacro("WSxRTS",nil,nil,"/cancelform [talent:2/3,form,@mouseover,help,nodead]\n/use [mod:alt]MOLL-E;[mod:ctrl]Stampeding Roar;[talent:3/3,mod]Incapacitating Roar;[talent:3/1,mod]Typhoon;[talent:2/3,noform,@mouseover,help,nodead]Wild Charge;[@cursor]Ursol's Vortex")
						EditMacro("WSxSGen+5",nil,nil,"/use [@party2,help,nodead,mod]Rejuvenation;[@mouseover,help,nodead,talent:1/2][talent:1/2]Nourish;[@mouseover,help,nodead,talent:1/3][talent:1/3]Cenarion Ward")
					end
				-- Demon Hunter, DH
				elseif class == "DEMONHUNTER" then
					EditMacro("WSxT15",nil,nil,"#showtooltip [talent:1/3]Felblade;[spec:2]Demon Spikes;Fel Rush\n/use "..invisPot)
					...
					EditMacro("WSxT45",nil,nil,"#showtooltip [spec:2,talent:3/3]Spirit Bomb;[spec:2]Demon Spikes;[spec:1,talent:3/3]Glaive Tempest;Fel Rush\n/use [mod:alt,spec:2,@player]Sigil of Silence;"..racials[race])
					EditMacro("WSxT90",nil,nil,"#showtooltip [spec:2,talent:6/3]Soul Barrier;[spec:1,talent:6/3]Fel Eruption;Throw Glaive\n/use [nocombat,noexists]Legion Invasion Simulator;Torment")
					EditMacro("WSxT100",nil,nil,"#showtooltip [spec:1,talent:7/3]Fel Barrage;[spec:2,talent:7/3]Bulk Extraction;Eye Beam")
					...
					EditMacro("WSxSGen+2",nil,nil,"#showtooltip\n/use [spec:2,talent:3/3]Spirit Bomb;[spec:1,talent:6/3]Fel Eruption;\n/startattack\n/targetenemy [noexists]\n/cleartarget [dead]\n/use Gnomish X-Ray Specs")
					EditMacro("WSxCSGen+2",nil,nil,"")
					...
					EditMacro("WSxSGen+4",nil,nil,"#showtooltip\n/use [spec:1,talent:5/3]Essence Break;[spec:1,talent:3/3]Glaive Tempest;[spec:1,talent:6/3]Fel Eruption;[spec:2]Shear;Glide\n/startattack\n/cleartarget [dead]\n/targetenemy [noexists]")
		...
		if (event == "BAG_UPDATE_DELAYED" or event == "PET_SPECIALIZATION_CHANGED" or event == "PLAYER_LOGIN") and not throttlef then 
			...
			elseif class == "HUNTER" then
				...
				EditMacro("WSxSGen+G",nil,nil,"#showtooltip\n/use [@mouseover,harm,nodead][harm,nodead]Tranquilizing Shot;Dash\n/use [nocombat,noexists,nomounted]Nat's Fishing Chair\n/stopmacro [combat]\n/run if not (IsControlKeyDown()) then if IsMounted() then DoEmote\"mountspecial\"; else DoEmote\"kneel\" end end")
			...
			-- Is class Druid
			elseif class == "DRUID" then
				EditMacro("WSxT75",nil,nil,"#showtooltip [mod]" ..bladlast..";[spec:1]Celestial Alignment;[spec:2,talent:5/2]Savage Roar;[spec:2/3]Berserk;[spec:4,talent:5/3]Incarnation: Tree of Life(Talent, Shapeshift)\n/use ".. bladlast) 
				EditMacro("WSxSGen+G",nil,nil,"#showtooltip\n/use "..ptdSG.."[spec:3/4,talent:3/2,form:2][spec:1,talent:3/1,form:2][spec:2,form:2]Maim;Soothe\n/use [noexists,nocombat]Flaming Hoop\n/targetenemy [noexists]") 
			-- Is class Demon Hunter
			elseif class == "DEMONHUNTER" then
				EditMacro("WSxT75",nil,nil,"#showtooltip [mod]" ..bladlast.. ";[spec:2,talent:5/3]Sigil of Chains;[spec:1,talent:5/3]Essence Break;Blade Dance\n/use " ..bladlast)
