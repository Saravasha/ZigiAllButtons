	...
	if InCombatLockdown() then
		...
		if (event == "LEARNED_SPELL_IN_SKILL_LINE" or event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "TRAIT_CONFIG_UPDATED" or event == "PLAYER_ENTERING_WORLD") then
			...
			elseif class == "PRIEST" then
				...
				EditMacro("WSxGen7",nil,nil,"#show\n/stopspelltarget\n/use "..(Get_Spell({{"Holy Word: Sanctify","[mod:shift,@player][@mouseover,exists,nodead][@cursor]",""},{"Shadow Crash","[mod:shift,@player][@mouseover,exists,nodead][@cursor]",""},{"Divine Star","",""},{"Halo","",""},{"Power Word: Life","[@mouseover,help,nodead][]",""},{"Schism","",""},{"Holy Nova","",""},}) or "").."\n/targetenemy [noexists]\n/cleartarget [dead]")
			...
			elseif class == "DRUID" then
				...
				EditMacro("WSxGen3",nil,nil,"#show\n/use "..(Get_Spell("Innervate","[@mouseover,help,nodead][help,nodead]",";") or "")..(Get_Spell("Rake","[form:2]",";") or "")..(Get_Spell("Ironfur","[form:1]",";") or "")..(Get_Spell("Starsurge","","") or "").."\n/targetenemy [noexists]\n/use Desert Flute")
				...
				EditMacro("WSxGen5",nil,nil,"#show\n/use "..(Get_Spell("Renewal","[mod:ctrl]",";") or "")..(Get_Spell({{"Raze","[noform:1]Bear Form;[form:1,harm,nodead]",";"},{"Lunar Beam","[noform:1]Bear Form;[form:1,harm,nodead]",";"},}) or "[form:1,harm,nodead]Mangle;").."[form:2,harm,nodead]Ferocious Bite;".."Wrath\n/targetenemy [noexists]\n/cleartarget [dead]")
