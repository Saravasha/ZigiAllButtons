...
local function eventHandler(event)
	...
	if InCombatLockdown() then
		...
		if (event == "LEARNED_SPELL_IN_SKILL_LINE" or event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "TRAIT_CONFIG_UPDATED" or event == "PLAYER_ENTERING_WORLD") then
			...
			-- Druid, dodo
			elseif class == "DRUID" then
				EditMacro("WSxGen1",nil,nil,"/use [@mouseover,help,dead][help,dead]Rebirth;"..(Get_Spell({{"Nourish","[@mouseover,help,nodead]",";"},{"Grove Guardians","[@mouseover,help,nodead]",";"},{"Sunfire","[@mouseover,harm,nodead]",";"},}) or "").."[nocombat,noexists]Druid and Priest Statue Set"..(Get_Spell({{"Nourish",";",""},{"Grove Guardians",";",""},{"Sunfire",";",""},}) or "").."\n/use [nocombat,noform:1/4]!Prowl\n/targetenemy [noexists]")
