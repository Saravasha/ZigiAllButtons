...
local function eventHandler(event)
	...
	if event == "ZONE_CHANGED_NEW_AREA" or event == "PLAYER_ENTERING_WORLD" or event == "LEARNED_SPELL_IN_SKILL_LINE" then
		...
		elseif (ZG.twwZones[z] and z == "Azj-Kahet") then
		...
		elseif (ZG.twwZones[z] and z == "Undermine") then
			if IsSpellKnownOrOverridesKnown(460013) then
				zA = "/use G-99 Breakneck"
			end
		end
    ...
    if (event == "ZONE_CHANGED_NEW_AREA" or event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "BAG_UPDATE_DELAYED" or event == "TRAIT_CONFIG_UPDATED" or event == "PLAYER_ENTERING_WORLD" or event == "PLAYER_LEVEL_UP" or event == "LEARNED_SPELL_IN_SKILL_LINE") then 
		...
		elseif ZG.z == "Undermine" then
			CZ = "Throwaway Gangster Disguise"
		...
		elseif instanceType == "party" or instanceType == "raid" then
			...
			EditMacro("WMPAlt+6",nil,nil,"/target [@boss3,exists,nodead,nomod:ctrl]\n/target [@arena3,exists,nodead,nomod:ctrl]\n/use [mod:ctrl,"..PoA.."3,nodead]"..ZA.aC[class]..alt6.."\n/use [mod:alt,"..PoA.."4]"..ZA.numaltbuff101112[class])
		...
		-- elseif (slBP ~= 0 and not ZG.slZones[z]) then
			...
			elseif class == "PRIEST" then
				covA = (Get_Spell({{"Premonition","",""},{"Shadow Crash","",""},{"Void Torrent","",""},{"Mindgames","",""},{"Power Word: Life","",""},{"Apotheosis","",""},}) or covA)
			...
			elseif class == "DRUID" then
				...
				sigA = (Get_Spell({{"Nature's Swiftness","",""},{"Astral Communion","",""},{"Fluid Form","Mangle;",""},{"Convoke the Spirits","",""},{"Adaptive Swarm","",""},}) or sigA)
	...
	if (event == "GROUP_ROSTER_UPDATE" or event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "TRAIT_CONFIG_UPDATED" or event == "PLAYER_ENTERING_WORLD" or event == "LEARNED_SPELL_IN_SKILL_LINE") then
		...
		elseif class == "PALADIN" then
			EditMacro("WSxGenX",nil,nil,"#show\n/use "..(Get_Spell({{"Retribution Aura","[mod:alt]!",";"},{"Concentration Aura","[mod:alt]!",";"},}) or "")..(Get_Spell("Blessing of Freedom","[mod:shift]",";") or "")..(Get_Spell({{"Barrier of Faith","[@mouseover,help,nodead]["..groupRosterBuilder("tank").."][]",""},{"Divine Favor","",""},{"Hand of Divinity","",""},{"Ardent Defender","",""},{"Shield of Vengeance","",""},{"Lay on Hands","[@mouseover,help,nodead]["..groupRosterBuilder("tank").."][]",""},}) or ""))
			if playerSpec == 2 and Get_Spell("Blessing of Sacrifice") then 
				override = "[@mouseover,help,nodead][help,nodead]["..groupRosterBuilder("healer").."]Blessing of Sacrifice;"
			elseif Get_Spell("Blessing of Sacrifice") then 
				override = "[@mouseover,help,nodead][help,nodead]["..groupRosterBuilder("tank").."]Blessing of Sacrifice;"
			end
			EditMacro("WSxGenC",nil,nil,"/use "..(Get_Spell({{"Repentance","[mod:ctrl,@mouseover,harm,nodead][mod:ctrl]",";"},{"Turn Evil","[mod:ctrl,@mouseover,harm,nodead][mod:ctrl]"},}) or "")..(Get_Spell({{"Blessing of Summer","[mod:shift]",";"},{"Blessing of Spellwarding","[mod:shift,"..groupRosterBuilder("healer").."]",";"},{"Blessing of Protection","[mod:shift,"..groupRosterBuilder("healer").."]",";"},}) or "[mod:shift,help,nodead]Holy Lightsphere;")..override..(Get_Spell("Blessing of Summer","","") or "Holy Lightsphere"))
		-- elseif class == "HUNTER" then
		-- elseif class == "ROGUE" then
		elseif class == "PRIEST" then
	...
	if (event == "LEARNED_SPELL_IN_SKILL_LINE" or event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "TRAIT_CONFIG_UPDATED" or event == "PLAYER_ENTERING_WORLD") then
		...
		elseif class == "PALADIN" then
			EditMacro("WSxGen1",nil,nil,"/use "..(Get_Spell("Intercession","[@mouseover,help,dead][help,dead]",";") or "")..(Get_Spell("Holy Light","[@mouseover,help,nodead][]",";") or "")..(Get_Spell({{"Crusader Aura","[nostance:2]!Devotion Aura;[nostance:2]",";"},{"Devotion Aura","[nostance:1]!",";"},}) or "").."Judgment\n/use Pretty Draenor Pearl\n/targetenemy [noexists]\n/cleartarget [dead]")
			...
			EditMacro("WSxGen5",nil,nil,"/use "..(Get_Spell({{"Ardent Defender","[mod:ctrl]",";"},{"Aura Mastery","[known:32223,mod:ctrl,stance:1][mod:ctrl,nostance]Devotion Aura;[mod:ctrl]",";"},}) or "")..(Get_Spell({{"Templar's Verdict","[harm,nodead]",";"},{"Holy Shock","[@mouseover,exists,nodead][exists,nodead]",";"},}) or "[spec:2,nocombat,noexists]Barrier Generator;[spec:2,harm,nodead]Shield of the Righteous")..(Get_Spell({{"Crusader Aura","[nostance:2]!Devotion Aura;[nostance:2]",";"},{"Devotion Aura","[nostance:1]!",";"},}) or "").."Judgment\n/targetenemy [noexists]\n/cleartarget [dead]")
		...
		elseif class == "ROGUE" then
			...
			EditMacro("WSxCSGen+G",nil,nil,"#show Blind\n/use [@focus,harm,nodead]Gouge\n/cancelaura Dark Ranger's Spare Cowl\n/cancelaura Warden Guise\n/cancelaura Ravenbear Disguise\n/cancelaura Horse Head Costume")	
			EditMacro("WSxGenH",nil,nil,"#show\n/use Crimson Vial\n/run if not (InCombatLockdown()) then if IsMounted() then DoEmote(\"mountspecial\") end end")
		...
		elseif class == "PRIEST" then
			...
			EditMacro("WSxGen7",nil,nil,"#show\n/stopspelltarget\n/use "..(Get_Spell({{"Holy Word: Sanctify","[mod:shift,@player][@mouseover,exists,nodead][@cursor]",""},{"Shadow Crash","[mod:shift,@player][@mouseover,exists,nodead][@cursor]",""},{"Divine Star","",""},{"Halo","",""},{"Power Word: Life","[@mouseover,help,nodead][]",""},{"Schism","",""},{"Holy Nova","",""},}) or "Shadow Word: Pain").."\n/targetenemy [noexists]\n/cleartarget [dead]")
			...
			EditMacro("WSxCGen+F",nil,nil,"#show "..(Get_Spell({{"Symbol of Hope","",""},{"Evangelism","",""},{"Psychic Scream","",""},}) or "").."\n/use [nocombat,noexists]Piccolo of the Flaming Fire;"..(Get_Spell({{"Vampiric Embrace","",""},{"Evangelism","",""},}) or "").."\n/cancelaura Twice-Cursed Arakkoa Feather\n/cancelaura Spirit Shell\n/use Xan'tish's Flute\n/use Leather Love Seat")
		...
		elseif class == "WARRIOR" then
			...
			EditMacro("WSxSGen+4",nil,nil,"#show\n/stopspelltarget\n/use "..(Get_Spell({{"Ravager","[@mouseover,exists,nodead][@cursor]",""},{"Skullsplitter","",""},{"Siegebreaker","",""},{"Sweeping Strikes","",""},{"Bladestorm","",""},}) or "Slam").."\n/startattack")
			...
			EditMacro("WSxGen8",nil,nil,"#show \n/use "..(Get_Spell({{"Recklessness","",""},{"Skullsplitter","",""},{"Sweeping Strikes","",""},{"Cleave","",""},{"Thunderous Roar","",""},{"Champion's Spear","[@player,mod][@cursor]",""},{"Challenging Shout","",""},{"Whirlwind","",""},}) or ""))
		...
		-- Druid, dodo
		elseif class == "DRUID" then
			EditMacro("WSxGen1",nil,nil,"/use [@mouseover,help,dead][help,dead]Rebirth;"..(Get_Spell({{"Nourish","[@mouseover,help,nodead]",";"},{"Grove Guardians","[@mouseover,help,nodead]",";"},{"Sunfire","[@mouseover,harm,nodead]",";"},{"Moonfire","[@mouseover,harm,nodead]",";"}}) or "").."[nocombat,noexists]Druid and Priest Statue Set"..(Get_Spell({{"Nourish",";",""},{"Grove Guardians",";",""},{"Sunfire",";",""},{"Moonfire",";",""},}) or "").."\n/use [nocombat,noform:1/4]!Prowl\n/targetenemy [noexists]")
			EditMacro("WSxSGen+1",nil,nil,"#show "..(Get_Spell({{"Moonfire","",""},{"Tranquility","",""},}) or "Mark of the Wild").."\n/use [mod:alt,@party3,nodead][mod:ctrl,@party2,help,nodead][@focus,help,nodead][@party1,help,nodead][@targettarget,help,nodead]Regrowth;Kalytha's Haunted Locket")
			EditMacro("WSxGen2",nil,nil,"/use [form:2]Shred;[form:1]Mangle;"..(Get_Spell({{"Invigorate","[@mouseover,help,nodead][help,nodead]",";"},{"Innervate","[@mouseover,help,nodead][help,nodead]",""},}) or "")..(Get_Spell("Moonfire","[@mouseover,harm,nodead][harm,nodead]",";") or "").."Moonfeather Statue\n/targetenemy [noexists]\n/cleartarget [dead]")
			...
			EditMacro("WSxGen5",nil,nil,"#show\n/use "..(Get_Spell("Renewal","[mod:ctrl]",";") or "")..(Get_Spell({{"Raze","[noform:1]Bear Form;[form:1,harm,nodead]",";"},{"Maul","[noform:1]Bear Form;[form:1,harm,nodead]",";"},{"Lunar Beam","[noform:1]Bear Form;[form:1,harm,nodead]",";"},}) or "[form:1,harm,nodead]Mangle;").."[form:2,harm,nodead]Ferocious Bite;".."Wrath\n/targetenemy [noexists]\n/cleartarget [dead]")
			...
			EditMacro("WSxCGen+F",nil,nil,"#show [nocombat,noexists]Mushroom Chair"..(Get_Spell({{"Cenarion Ward",";",""},{"Nature's Vigil",";",""},{"Heart of the Wild",";",""},{"Symbiotic Relationship",";",""},}) or "").."\n/use [nocombat,noexists]Mushroom Chair"..(Get_Spell({{"Nature's Vigil",";",""},{"Heart of the Wild",";",""},{"Symbiotic Relationship",";",""},}) or ""))
